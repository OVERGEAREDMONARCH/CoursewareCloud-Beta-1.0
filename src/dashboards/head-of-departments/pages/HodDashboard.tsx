    ...
    <HodLayout>
      <div className="space-y-6 animate-fade-in">
        <div className="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-xl p-6 text-white">
          ...
          <p className="opacity-90">Managing Computer Science Department with 24 faculty members and 456 students.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{departmentStats.activeCourses}</div>
              <p className="text-xs text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{departmentStats.pendingRequests}</div>
              <p className="text-xs text-muted-foreground">
                ...
                {upcomingMeetings.map((meeting) => (
                  <div key={meeting.id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    ...
                    <div className="text-right">
                      <p className="text-sm text-gray-600 dark:text-gray-300">{meeting.attendees} attendees</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <CardContent>
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-2 p-2 bg-green-50 dark:bg-green-900/20 rounded-lg">
                  ...
                  <div>
                    <p className="text-sm font-medium">Accreditation Approved</p>
