  ...
  return (
      <div className="space-y-6 animate-fade-in">
        ...
        <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl p-6 text-white">
          ...
          <p className="opacity-90">You have 5 active courses and 3 pending assignments. Keep up the great work!</p>
        </div>
            ...
            <div className="bg-white dark:bg-gray-700 rounded-xl p-6 shadow-sm">
              ...
              <div className="space-y-3">
                <button className="w-full text-left p-3 bg-blue-50 dark:bg-blue-900/20 hover:bg-blue-100 dark:hover:bg-blue-900/30 rounded-lg transition-colors">
                  <span className="font-medium text-blue-700 dark:text-blue-300">Join Live Lecture</span>
                  <p className="text-sm text-blue-600 dark:text-blue-400">Advanced React Development</p>
                </button>
                <button className="w-full text-left p-3 bg-purple-50 dark:bg-purple-900/20 hover:bg-purple-100 dark:hover:bg-purple-900/30 rounded-lg transition-colors">
                  <span className="font-medium text-purple-700 dark:text-purple-300">Schedule Study Session</span>
                  <p className="text-sm text-purple-600 dark:text-purple-400">Book a time slot</p>
                </button>
                <button className="w-full text-left p-3 bg-green-50 dark:bg-green-900/20 hover:bg-green-100 dark:hover:bg-green-900/30 rounded-lg transition-colors">
                  <span className="font-medium text-green-700 dark:text-green-300">Access Library</span>
                  <p className="text-sm text-green-600 dark:text-green-400">Digital resources</p>
                </button>
              </div>
            </div>
          </div>
