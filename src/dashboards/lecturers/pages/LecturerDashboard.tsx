    ...
    <LecturerLayout>
      <div className="space-y-6 animate-fade-in">
        ...
        <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-xl p-6 text-white">
          ...
          <p className="opacity-90">You have 3 active courses with 135 total students. 20 assignments need grading.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="bg-white dark:bg-gray-700 rounded-xl p-6 shadow-sm">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900 dark:text-white">135</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-700 rounded-xl p-6 shadow-sm">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600 dark:text-gray-300">This Week Classes</p>
